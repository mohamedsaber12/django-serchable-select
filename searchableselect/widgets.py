...
class SearchableSelect(forms.CheckboxSelectMultiple):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.addition_filter = kwargs.pop("addition_filter", None)
        self.addition_filter_condition = kwargs.pop("addition_filter_condition", None)
    ...
    def render(self, name, value, attrs=None, choices=()):
        ...
        return render_to_string(
            ...
            dict(
                ...
                limit=self.limit,
                many=self.many,
                addition_filter=self.addition_filter,
                addition_filter_condition=self.addition_filter_condition
        ),
        )
